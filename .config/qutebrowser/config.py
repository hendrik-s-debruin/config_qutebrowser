...
#c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(29, 31, 33, 1), stop:1 rgba(40, 42, 46, 1))'
...
#### Status bar
#### Caret mode not yet implemented
...
#### Tab bar
# much is skipped due to my not using tabs
...
# webpage default background
c.colors.webpage.bg = lightgray
